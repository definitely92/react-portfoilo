...
import IconEducation from "../assets/images/Education";
...
const experience = [
  {
    id: "1",
    type: <IconBxBuilding color="white" />,
  ...
  {
    id: "3",
    type: <IconEducation color="white" />,
...
const Experience = ({ time, type, name, desc }) => {
  return (
...
const About = () => {
  ...
  return (
    <div id="wrap" className={"light effect__start " + fade}>
      <Header info="none" />
      <Layout>
