export const detailInfo = [
  ...
  {
    id: 14,
    image1: "/react-portfolio/img/lush_shop_2.gif",
    image2: "/react-portfolio/img/lush_shop_3.gif",
    title: "러쉬 온라인 스토어 클론 코딩",
    desc1:
      "리액트 라이브러리를 사용하여 러쉬 공식 온라인 스토어의 메인페이지와 상품상세, 장바구니 페이지를 클론 코딩 하였습니다.",
    desc2:
      "컴포넌트로 UI를 나누어 개별적으로 관리가 가능하고 모바일 환경으로만 되어있는 현재 사이트를 반응형으로 구현해보았으며, \n상품 상세페이지에 각 상품의 데이터가 전달되어 보여지고, 장바구니에 따로 상품을 담아서 개수 별 총 금액을 계산 할 수 있게 장바구니 페이지를 만들었습니다.",
    source: "https://definitely92.github.io/lush",
    techStack1: "scss",
    techStack2: "Javascript",
    techStack3: "react",
    type: "Toy",
